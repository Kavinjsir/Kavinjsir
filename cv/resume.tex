...
Pioneered cloud and blockchain infrastructure development to establish and scale the company's core network.
\begin{itemize}
  ...
  \item Pioneered cloud infrastructure, ensuring HA, scalability, and security for company growth.
  \item Led successful Layer 1 mainnet launch, ensuring security, performance, and network stability.
  \item Advanced observability frameworks, bolstering stability and cutting downtime by 80\%.
  \item Stacks: Go, Kubernetes, Pulumi, GCP/AWS, Prometheus, Grafana, L1 Blockchain, CI/CD Tools
\end{itemize}

\datedsubsection{\textbf{Rill Data} | Lead Infrastructure Engineer | San Francisco, CA}{Nov 2023 -- Nov 2024}
Lead Architect of Cloud Infrastructure for High-Volume Data Services
\begin{itemize}
  \item Architected K8s platforms for pivotal products, guaranteeing high availability and seamless scaling.
  \item Spearheaded the development of auto-scaling features, slashing resource cost by over 60\%.
  \item Engineered robust database systems using ClickHouse and Druid, supporting high QPS at terabyte scale.
  \item Stacks: Kubernetes, GCloud, AWS, Terraform, Go, ClickHouse, Druid, Kafka, Zookeeper, Airflow.
\end{itemize}
