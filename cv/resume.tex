...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Programming Languages: Go, Linux shell, TypeScript
  \item App Stacks: ReactJS, PostgreSQL, Express.JS
\end{itemize}

\section{\faUsers\ Contribution Experience}
\datedsubsection{\textbf{Google Summer of Code 2022} | Kubernetes Contributor, CNCF | Remote}{June 2022 -- Sep 2022}
% \role{Developer}{}
