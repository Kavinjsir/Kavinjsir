...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Infra Stacks: K8s, AWS, GCP, Prometheus, OpenTelemetry, Grafana, Github Action, Terraform
  \item Active Open-source Contributor, Kubernetes-sigs Maintainer, KubeCon Speaker, GSoC Mentor
  \item Programming Languages: Go, C++, Python, Java, Rust, TypeScript, Linux shell
\end{itemize}
...
\begin{itemize}
  ...
  \item Established observability standards across rich telemetries, reducing downtime by 80\%.
  \item Stacks: Go, Kubernetes, Pulumi, GCP/AWS, Prometheus, Grafana, CI/CD, Blockchain systems.
\end{itemize}
...
\begin{itemize}
  ...
  \item Stacks: Kubernetes, GCP, AWS, Terraform, Go, ClickHouse, Druid, Kafka, Zookeeper, Airflow.
\end{itemize}
...
\begin{itemize}
  ...
  \item Technologies: Go, Kubernetes, Azure, Terraform, Ansible, Linux, CI/CD
