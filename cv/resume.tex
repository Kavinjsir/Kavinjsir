...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Monitoring Stacks: Prometheus, Grafana, Jaeger, Loki, OpenTelemetry, ELK, Thanos
...
%  \item Dynamically allocated resources with the integration of K8s Hpa and AWS Cluster Autoscaler.
  ...
  \item Stacks: TypeScript, Kubernetes, AWS, Terraform, Ansible, Prometheus, Grafana, Jaeger, Loki, ELK
\end{itemize}
