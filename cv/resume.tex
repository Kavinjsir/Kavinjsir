...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Database Stacks: ClickHouse, Druid, DuckDB, PostgreSQL, MongoDB
  \item DataEng Stacks: Airflow, Spark, Zookeeper, Kafka, RabbitMQ
  \item Infra Stacks: Kubernetes, Aws, Azure, GCloud, Terraform, Docker, Gitlab-CI, Github-Actions
  \item Monitoring Stacks: Prometheus, OpenTelemetry, Grafana, Jaeger, Loki, Datadog, ELK
  \item Programming Languages: Go, C++, Python, Java, Rust, TypeScript, Linux shell
\end{itemize}

\section{\faUsers\ Working Experience}
\datedsubsection{\textbf{Rill Data} | Cloud Infrastructure Engineer | San Francisco, CA}{Jan 2024 --}
Lead Architect of Cloud Infrastructure for High-Volume Data Services
\begin{itemize}
  \item Established RillData’s cloud infrastructure, powering data-intensive services across the cloud.
  ...
  \item Spearheaded the development of auto-scaling features, slashing resource use by over 60\%.
  \item Advanced observability frameworks, bolstering stability and cutting downtime by 80\%.
  \item Refined dev/test/release/monitor workflows, boosting the team's delivery efficiency by 50\%.
  \item Stacks: Go, C++, Java, ClickHouse, Druid, Kafka, Zookeeper, Airflow, Kubernetes, GCloud, AWS.
\end{itemize}


\datedsubsection{\textbf{Microsoft} | Senior Software Engineer(Contractor), Azure | Boston, MA}{Jan 2023 -- Dec 2023}
...
\datedsubsection{\textbf{The Kubernetes Community} | Repository Reviewer, Contributor, Kubernetes-sigs}{Mar 2022 -- }
% \role{Developer}{}
Active Maintenance Contributor(Maintainer) within the Kubebuilder Repository
\begin{itemize}
