...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Monitoring Stacks: Prometheus, Grafana, Loki, Jaeger
  \item Programming Languages: TypeScript, Go, C++
  \item App Stacks: ReactJS, Webpack, Koa, Express
\end{itemize}

\section{\faUsers\ Contribution Experience}
\datedsubsection{\textbf{Kubebuilder} | GSoC 2022 | Remote}{Jun 2022 -- }
% \role{Developer}{}
A Grafana Dashboard Plugin to Observe Controller Metrics
\begin{itemize}
  \item Created a new plugin to scaffold Grafana manifests for operator status visualiation.
  \item Enable dynamic manifests for user-defined custom metrics
